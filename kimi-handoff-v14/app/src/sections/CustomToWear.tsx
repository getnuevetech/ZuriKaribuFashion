...
interface CustomToWearProps {
  className?: string;
}

export default function CustomToWear({ className = '' }: CustomToWearProps) {
      ...
      >
        <div className="absolute left-[4vw] top-[22vh] w-[28vw]">
          ...
          >
            ...
            <span className="word inline-block">stitch</span>{' '}
            <span className="word inline-block">sewn</span>{' '}
          ...
          <div className="relative">
            ...
            {/* Thread SVG */}
            <svg 
              className="absolute -bottom-3 left-0 w-48 h-2"
              viewBox="0 0 200 8"
              fill="none"
            >
              <path 
