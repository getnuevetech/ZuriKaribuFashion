...
interface FeaturedReadyToWearProps {
  className?: string;
}

export default function FeaturedReadyToWear({ className = '' }: FeaturedReadyToWearProps) {
  ...
  return (
    ...
    >
      ...
      >
        <img 
          src="/featured_rw_left.jpg" 
          alt="Ready to wear fashion left"
      ...
      >
        <img 
          src="/featured_rw_right.jpg" 
          alt="Ready to wear fashion right"
          className="w-full h-full object-cover editorial-image"
        />
      </div>
      ...
      >
        <h3 className="headline-lg text-[clamp(24px,2.5vw,40px)] text-white mb-4">
          Made to standard sizes for all.
        </h3>
        <p className="text-sm text-white/70 leading-relaxed mb-6">
          Clean silhouettes, true-to-size fits, and finishing that holds up — wear it out of the box.
        </p>
        <a 
          href="#shop-rw" 
