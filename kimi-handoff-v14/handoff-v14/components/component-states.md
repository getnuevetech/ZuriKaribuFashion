...
| **Hover** | BG: `--color-brand-primary-hover`, translateY: -2px | `background: #D14A2E; transform: translateY(-2px);` |
...
| State | Visual | CSS |
|-------|--------|-----|
| **Default** | Border: `--color-border-strong`, BG: transparent | `border: 1px solid rgba(26,25,23,0.2);` |
...
| State | Visual | CSS |
|-------|--------|-----|
| **Default** | Border: `--color-border-default`, BG: `--color-bg-secondary` | `border: 1px solid rgba(26,25,23,0.1);` |
| **Hover** | Border: `--color-border-strong` | `border-color: rgba(26,25,23,0.2);` |
...
| **Disabled** | BG: `--color-bg-tertiary`, opacity: 0.6 | `background: #F5F3EF; opacity: 0.6;` |
...
| State | Visual | CSS |
|-------|--------|-----|
| **Default** | Text: `--color-text-secondary` | `color: #6B665C;` |
...
```
- BG: linear-gradient(90deg, #F5F3EF 25%, #FAF9F7 50%, #F5F3EF 75%)
...
### Page Loading
```
- Full-screen overlay: rgba(250, 249, 247, 0.8)
...
4. Utility actions (search, cart, theme, sign in)
