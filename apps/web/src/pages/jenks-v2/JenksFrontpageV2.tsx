...
const RTW_FTB_CTW_SECTIONS = [
  ...
  },
  {
    id: 'ctw-steps',
    key: 'CTW',
    sectionName: 'CTW STEPS',
    title: 'FEATURED CTW STEPS',
    description: 'Step-by-step CTW journey powered as a standalone section, duplicated from FTB and fully independent.',
    cta: 'EXPLORE CTW STEPS',
    href: '/customtowear',
    image: `${ASSET_BASE}/fabrics_full.jpg`,
    sectionHeightPx: 0,
    columnHeightPx: 0,
  ...
  useEffect(() => {
    ...
    const loadConfig = async () => {
      try {
        ...
        if (!cancelled) {
          setManagerConfig(null);
          setManagerConfigLoadError('Failed to load primary homepage configuration.');
        }
      } finally {
