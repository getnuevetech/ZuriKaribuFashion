...
const ROUTE_OPTIONS: RouteOption[] = [
  ...
  { key: 'FABRICS', label: 'Fabrics', href: '/fabricstobuy' },
...
const DEFAULT_CONFIG: JenksHomepageConfig = {
  ...
  navigation: {
    ...
    leftMenuLinks: [
      ...
      { label: 'Ready To Wear', href: '/readytowear', routeKey: 'READY_TO_WEAR', enabled: true },
      { label: 'Fabric To Buy', href: '/fabricstobuy', routeKey: 'FABRICS', enabled: true },
      { label: 'Custom To Wear', href: '/customtowear', routeKey: 'CUSTOM_TO_WEAR', enabled: true },
    ],
    rightMenuLinks: [
  ...
  hero: {
    ...
    quickLinks: [
      ...
      { label: 'Custom', href: '/customtowear' },
