    ...
    if (payload.type === ProductType.DESIGN) {
      ...
      const created = await prisma.design.create({
        data: {
          ...
          hasAdditionalMaterialOrFabric: payload.hasAdditionalMaterialOrFabric === true,
          name: payload.name.trim(),
          description: payload.description.trim(),
      ...
      const updated = await prisma.design.update({
        ...
        data: {
          ...
          hasAdditionalMaterialOrFabric:
            payload.hasAdditionalMaterialOrFabric === undefined ? undefined : payload.hasAdditionalMaterialOrFabric === true,
          basePrice: resolvedPrice,
          finalPrice: resolvedPrice,
          status: payload.status,
          isAvailable: payload.isAvailable,
