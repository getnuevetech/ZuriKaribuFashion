...
import jenksV2FrontpageManagerRoutes from './routes/jenks-v2-frontpage-manager';
...
import categoryPagesV2Routes from './routes/category-pages-v2';
...
app.use('/api/jenks-v2-frontpage', jenksV2FrontpageManagerRoutes);
...
app.use('/api/category-pages-v2', categoryPagesV2Routes);
